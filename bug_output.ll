...
@.str.0 = private unnamed_addr constant [3 x i8] c"a:\00"
...
bb1:
  %v10 = load i64, i64* %v2
  %v12 = icmp slt i64 %v10, 1
  %v11 = zext i1 %v12 to i64
...
bb2:
  ...
  %v17 = load i64, i64* %v5
  %v18 = add i64 %v16, %v17
  store i64 %v18, i64* %v6
  %v19 = load i64, i64* %v6
  store i64 %v19, i64* %v5
  %v20 = load i64, i64* %v5
  store i64 %v20, i64* %v0
  %v21 = load i64, i64* %v5
  store i64 %v21, i64* %v1
  %v22 = load i64, i64* %v2
  %v23 = add i64 %v22, 1
  ...
  br label %bb1
bb3:
  %v25 = getelementptr [3 x i8], [3 x i8]* @.str.0, i64 0, i64 0
  %v26 = call i8* @roast_str_new(i8* %v25, i64 2)
  %v27 = ptrtoint i8* %v26 to i64
  %v28 = call i64 @roast_print(i64 %v27)
  store i64 %v28, i64* %v8
  br label %bb4
bb4:
  %v29 = load i64, i64* %v5
  %v30 = call i64 @roast_print(i64 %v29)
  store i64 %v30, i64* %v9
  br label %bb5
bb5:
  ret i64 0
}
