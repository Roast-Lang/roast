...
entry:
  ...
  %v1 = alloca i64
  %v2 = alloca i64
  %v3 = call i64 @roast_fn_87(i64 40)
  store i64 %v3, i64* %v1
  br label %bb1
bb1:
  %v4 = load i64, i64* %v1
  store i64 %v4, i64* %v0
  %v5 = load i64, i64* %v0
  %v6 = call i64 @roast_print(i64 %v5)
  store i64 %v6, i64* %v2
  br label %bb2
bb2:
  ret i64 0
...
entry:
  ...
  %v8 = load i64, i64* %v0
  %v10 = icmp sle i64 %v8, 1
  %v9 = zext i1 %v10 to i64
  store i64 %v9, i64* %v1
  %v11 = load i64, i64* %v1
  store i64 %v11, i64* %v2
  %v12 = load i64, i64* %v2
  %v13 = icmp eq i64 %v12, 1
  br i1 %v13, label %bb1, label %bb2
bb1:
  %v14 = load i64, i64* %v0
  ret i64 %v14
bb2:
...
bb3:
  %v18 = load i64, i64* %v0
  %v19 = sub i64 %v18, 2
  store i64 %v19, i64* %v6
  %v20 = load i64, i64* %v6
  store i64 %v20, i64* %v0
  br label %bb0
bb4:
  %v21 = load i64, i64* %v3
  %v22 = load i64, i64* %v5
  %v23 = add i64 %v21, %v22
  store i64 %v23, i64* %v7
  %v24 = load i64, i64* %v7
  ret i64 %v24
}
...
; Debug Info metadata
!0 = !DIFile(filename: "fibonacci.roast", directory: "examples")
...
!4 = distinct !DISubprogram(name: "89", linkageName: "roast_fn_89", scope: !0, file: !0, line: 1, type: !5, scopeLine: 1, spFlags: DISPFlagDefinition, unit: !1)
!5 = !DISubroutineType(types: !6)
!6 = !{null}
!7 = distinct !DISubprogram(name: "87", linkageName: "roast_fn_87", scope: !0, file: !0, line: 1, type: !8, scopeLine: 1, spFlags: DISPFlagDefinition, unit: !1)
!8 = !DISubroutineType(types: !9)
!9 = !{null}
!10 = distinct !DISubprogram(name: "main", linkageName: "main", scope: !0, file: !0, line: 1, type: !11, scopeLine: 1, spFlags: DISPFlagDefinition, unit: !1)
