...
@.str.1 = private unnamed_addr constant [9 x i8] c"__main__\00"
@.str.0 = private unnamed_addr constant [20 x i8] c"Hello from project!\00"
...
entry:
  ...
  br label %bb0
bb0:
  %v1 = getelementptr [20 x i8], [20 x i8]* @.str.0, i64 0, i64 0
  %v2 = call i8* @roast_str_new(i8* %v1, i64 19)
...
entry:
  ...
  br label %bb0
bb0:
  %v3 = getelementptr [9 x i8], [9 x i8]* @.str.1, i64 0, i64 0
  %v4 = call i8* @roast_str_new(i8* %v3, i64 8)
  %v5 = ptrtoint i8* %v4 to i64
  %v6 = getelementptr [9 x i8], [9 x i8]* @.str.1, i64 0, i64 0
  %v7 = call i8* @roast_str_new(i8* %v6, i64 8)
  %v8 = ptrtoint i8* %v7 to i64
  %v10 = inttoptr i64 %v5 to i8*
  %v11 = inttoptr i64 %v8 to i8*
  %v12 = call i1 @roast_str_eq(i8* %v10, i8* %v11)
  %v9 = zext i1 %v12 to i64
  store i64 %v9, i64* %v0
  %v13 = load i64, i64* %v0
  store i64 %v13, i64* %v1
  %v14 = load i64, i64* %v1
  %v15 = icmp eq i64 %v14, 1
  br i1 %v15, label %bb1, label %bb2
bb1:
  %v16 = call i64 @roast_fn_87()
  store i64 %v16, i64* %v2
  br label %bb3
bb2:
  ret i64 0
bb3:
