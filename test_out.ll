...
@.str.0 = private unnamed_addr constant [16 x i8] c"initial values:\00"
@.str.2 = private unnamed_addr constant [9 x i8] c"final b:\00"
@.str.1 = private unnamed_addr constant [14 x i8] c"temp = a + b:\00"
@.str.3 = private unnamed_addr constant [8 x i8] c"result:\00"
...
define i64 @roast_fn_93() {
entry:
  %v0 = alloca i64
  %v1 = alloca i64
  %v2 = alloca i64
  %v3 = alloca i64
  %v4 = call i64 @roast_fn_87()
  store i64 %v4, i64* %v1
  br label %bb1
bb1:
  %v5 = load i64, i64* %v1
  store i64 %v5, i64* %v0
  %v6 = getelementptr [8 x i8], [8 x i8]* @.str.3, i64 0, i64 0
  %v7 = call i8* @roast_str_new(i8* %v6, i64 7)
...
entry:
  ...
  store i64 1, i64* %v1
  store i64 2, i64* %v2
  %v16 = getelementptr [16 x i8], [16 x i8]* @.str.0, i64 0, i64 0
  %v17 = call i8* @roast_str_new(i8* %v16, i64 15)
...
bb1:
  %v20 = load i64, i64* %v9
  %v21 = call i64 @roast_print(i64 %v20)
  store i64 %v21, i64* %v4
  br label %bb2
bb2:
  %v22 = load i64, i64* %v9
  %v23 = call i64 @roast_print(i64 %v22)
  store i64 %v23, i64* %v5
  br label %bb3
bb3:
  %v24 = load i64, i64* %v2
...
bb5:
  %v26 = load i64, i64* %v2
  %v28 = icmp sle i64 %v26, 5
  %v27 = zext i1 %v28 to i64
  store i64 %v27, i64* %v7
  %v29 = load i64, i64* %v7
  store i64 %v29, i64* %v8
  %v30 = load i64, i64* %v8
  %v31 = icmp eq i64 %v30, 1
  br i1 %v31, label %bb6, label %bb7
bb6:
  %v32 = load i64, i64* %v9
  %v33 = load i64, i64* %v9
  %v34 = add i64 %v32, %v33
  store i64 %v34, i64* %v10
  %v35 = load i64, i64* %v10
  store i64 %v35, i64* %v9
  %v36 = getelementptr [14 x i8], [14 x i8]* @.str.1, i64 0, i64 0
  %v37 = call i8* @roast_str_new(i8* %v36, i64 13)
  %v38 = ptrtoint i8* %v37 to i64
  %v39 = call i64 @roast_print(i64 %v38)
  store i64 %v39, i64* %v11
  br label %bb8
bb7:
  %v40 = getelementptr [9 x i8], [9 x i8]* @.str.2, i64 0, i64 0
  %v41 = call i8* @roast_str_new(i8* %v40, i64 8)
  %v42 = ptrtoint i8* %v41 to i64
  %v43 = call i64 @roast_print(i64 %v42)
  store i64 %v43, i64* %v14
  br label %bb10
bb8:
  %v44 = load i64, i64* %v9
  %v45 = call i64 @roast_print(i64 %v44)
  store i64 %v45, i64* %v12
  br label %bb9
bb9:
  %v46 = load i64, i64* %v9
  store i64 %v46, i64* %v0
  %v47 = load i64, i64* %v9
  store i64 %v47, i64* %v1
  %v48 = load i64, i64* %v2
  %v49 = add i64 %v48, 1
  store i64 %v49, i64* %v13
  %v50 = load i64, i64* %v13
  store i64 %v50, i64* %v2
  br label %bb5
bb10:
  %v51 = load i64, i64* %v9
  %v52 = call i64 @roast_print(i64 %v51)
  store i64 %v52, i64* %v15
  br label %bb11
bb11:
  %v53 = load i64, i64* %v1
  ret i64 %v53
